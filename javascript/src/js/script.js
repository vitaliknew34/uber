    ...
    /* let browser = prompt('Какой?');
       ...
       /*  let a = 3;
        ...
        function calc() {
            ...
            if ( c == '-' || c == 'вычитание'|| c == 'Вычитание'|| c == 'Вычетание'|| c == 'вычетание' ) {
                alert(`вычитание ответ: ${a - b}`);
            }
            if ( c == '*' || c == 'умножение' || c == 'Умножение' || c == 'умнажение' || c == 'Умнажение' ) {
                alert(`умножение ответ: ${a * b}`);
            }
            if ( c == '/' || c == 'Деление' || c == 'деление' ) {
                alert(`деление ответ: ${a / b}`);
            }
            
            else {
                alert('ошибка ввода, повторите')
                while(  c == '+'  || c == 'Сложение'|| c !== 'сложение' || c == !'Слажение'|| c !== 'слажение' || c !== 'плюс' || c !== 'Плюс' ) {
                    
                    alert(prompt('какое действие выполнить?', '')) 
